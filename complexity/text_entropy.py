...
def p_words(caption):
    ...
    count_fr_ws, count_fr_ns = p2(caption)
    return ws_counts, cws_counts, nouns_counts, adjs_counts, count_fr_ws, count_fr_ns
...
def p2(caption):
    ...
    for w in cws:
        ...
        if w in dict_frequents_nouns:
            count_fr_ns +=1    
    return count_fr_ws, count_fr_ns
#%%
dict_tid_to_p = {}
for tid in dict_unique_text_tids:
    caption = dict_tid_to_caption [tid]
    ws_counts, cws_counts, nouns_counts, adjs_counts, count_fr_ws, count_fr_ns = p_words(caption)
    dict_tid_to_p [tid] = {}
